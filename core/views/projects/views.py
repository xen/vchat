...
from core.app_keys import SIGNER_KEY
from core.document_types import DEFAULT_DOCUMENT_TYPE
...
from core.utils import flash, login_required, meta
...
async def project_chat(request):
    ...
    payload = serializer.dumps([request["user"].id, chat.short_id], salt="core")
...
async def public_project_chat(request):
    ...
    serializer = URLSafeSerializer(config.get("secret_key"))
    payload = serializer.dumps([user_uid, chat.short_id], salt="core")
