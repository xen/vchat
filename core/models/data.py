...
from .plan import Plan, plan_enum, token_limit_for_plan
...
class Project(Base, Created, Updated, ShortId):
    ...
    def apply_tariff(self) -> None:
        self.token_limit = token_limit_for_plan(self.plan)
...
class ProjectUser(Base):
    ...
    project_id: Mapped[int] = mapped_column(
        sa.Integer, ForeignKey("project.id"), nullable=False
    )
    user_id: Mapped[int] = mapped_column(
        sa.Integer, ForeignKey("users.id", ondelete="CASCADE"), nullable=False
    )
    role: Mapped[str] = mapped_column(project_role_enum, nullable=False)
...
class Source(Base, Created, Updated, ShortId):
