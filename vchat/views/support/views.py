...
from vchat.models.support import Chapter, Page, Ticket, TicketComment
from vchat.utils import flash, login_required, json
...
async def support_actions(request):
    ...
    if action == "update_chapter_order":
        ...
        if "uploads" in data:
            ...
            from vchat.utils import save_upload
        ...
        from vchat.utils import sendmessage
